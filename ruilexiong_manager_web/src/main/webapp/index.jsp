    ...
    <div class="container">
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#about">注册</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#projects">登录</a>
                </li>
                <li class="nav-item">
...
<header class="masthead">
    <div class="container d-flex h-100 align-items-center">
        <div class="mx-auto text-center">
            ...
            <a href="/WEB-INF/jsp/a.jsp" class="btn btn-primary js-scroll-trigger">Let's Start Learning English</a>
        </div>
    </div>
</header>
<!-- Footer -->
